  ...
  const handleScan = async (item: string) => {
    ...
    try {
      ...
      const postResponse = await fetch(
        `https://robotmanagerv1test.qikpod.com/nanostore/transaction?order_id=${orderId}&item_id=${item}&transaction_item_quantity=1&transaction_type=outbound&transaction_date=${currentDate}`,
        {
          method: 'POST',
          headers: {
            'accept': 'application/json',
